...
module.exports = {
	...
	// Project options.
	projectURL: 'https://lartenplus.mosne.it/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	editorStyleSRC: './assets/scss/editor-style.scss', // Path to main .scss file.
